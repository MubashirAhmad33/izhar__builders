  ...
  return (
    <>
      ...
      <div className="fixed bottom-10 right-10 z-50">
        <GhostButton
          className="px-6 py-3 gap-2 shadow-lg hover:scale-105 transition-transform"
          onClick={() => setOpen(true)}
        >
          Build Your Dream <ArrowRightIcon size={18} />
        </GhostButton>
      </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                ideal residential or commercial space — on time, on budget, and
